...
public class BoardingActivity extends AppCompatActivity {
    ...
    /* uncomment this if you need launch boarding at first time only */
        ...
        viewPagerPageChangeListener = new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int arg0, float arg1, int arg2) {
                if (arg1 > 0) {
                    ...
                    int margin = convertDpToPixel(arg0 * 50, getApplicationContext());
    ...
    public void dotSetup() {
        ...
        for (int i = 0; i < dots.length; i++) {
            ...
            int margin = convertDpToPixel(i * 50, getApplicationContext());
