...
public class AnnulamenoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_annullameno);
        final ViewPager2 viewpager = findViewById(R.id.activity_main_viewpager2_viewpage);
        List<Fragment> mFragments = new ArrayList<>();
        mFragments.add(new FragmentAnnullameno());
        mFragments.add(new FragmentAnnullameno1());
        mFragments.add(new FragmentAnnullamen2());
        mFragments.add(new FragmentAnnullameno3());
